...
- **Train Dataset:** `Dati_HIS_Serra_Cs_Hv_Sl_Zm_no_Fe_modified`  
  - This modified train set includes **36 manually added samples** from `"Michele_test"` to `"Dati_HIS_Serra_Cs_Hv_Sl_Zm_no_Fe"`.

- **Test Dataset:** `Merged_Anna1_Anna2_Marco1_Michele_new_trainSet`  
